...
const scrap1337x = require('./src/1337x');
const scrapNyaa = require('./src/nyaaSI');
const scrapYts = require('./src/yts');
...
const zooqle = require('./src/zooqle');
const kickAss = require('./src/kickAss');
const bitSearch = require('./src/bitSearch');
